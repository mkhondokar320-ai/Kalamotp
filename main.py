    ...
    while True:
        ...
        for otp in reversed(otps_1):
            ...
            if otp_id not in seen_otps:
                success = send_to_telegram(number, platform, message, final_otp)
                if success:
